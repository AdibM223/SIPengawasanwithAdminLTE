...
<body class="align">
  ...
  @if(session('error'))
            ...
            @endif
    <form action="{{ route('actionlogin') }}" method="POST" class="form login">
    @csrf
    <div >
    <img src="https://www.bpjs-kesehatan.go.id/bpjs//themes/webbpjs/img/logo/logo-bpjs.png" height="60" width="400" alt="usp">
    </div>
