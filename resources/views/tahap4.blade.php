...
<div class="container">
  <div class="card">
    <div class="card-header bg-primary text-white">Form Registrasi Tahap 4</div>
    <div class="card-body">
<form action='/regisbu/updatetahap4' method='post'>
{{ csrf_field() }}
...
<div class="form-group">
  ...
  @endforeach
  <div class="form-group">
    <label for="exampleFormControlSelect1">Tanggal Surat Teguran II</label>
    <input type="date" class="form-control" name='tgl_surat_teguranII' required>
  </div>
  <div class="form-group">
    <label for="exampleFormControlSelect1">Kepatuhan</label>
    <select name="kepatuhanku" id="kepatuhanku" class="form-control" required onchange="kepatuhan();">
 ...
 <div>
 <input type="hidden" class="form-control"  name='status_tahap4' id="status_tahap4">
 <br>
 ...
 <script>
  ...
  function kepatuhan()
  {
    ...
    if(patuhnya == "Patuh")
  {
    document.getElementById('status_tahap4').value='Patuh';
  }
  else if (patuhnya == "Tidak Patuh")
  {
    document.getElementById('status_tahap4').value='Tidak Patuh';
  }
  }
