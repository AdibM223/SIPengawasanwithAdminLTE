...
<div class="container">
  <div class="card">
    <div class="card-header bg-primary text-white">Form Tambah Master Data Badan Usaha Terdaftar</div>
    <div class="card-body">
<form action='/masterbu/inputmasterbu' method='post'>
{{ csrf_field() }}
  <div class="form-group">
    <label for="exampleFormControlSelect1">Wilayah Kerja Badan Usaha</label>
    <select name="kode_bu" id="kode_bu" class="form-control" required >
    <option value="" selected></option>
    @foreach ($wil as $t)
    <option  value='0{{$t->id}}800'>{{$t->id}} - {{$t->namawil}}</option>
    @endforeach
    </select>
  </div>
  <div class="form-group">
    <label for="exampleFormControlInput1">Nama Badan Usaha</label>
    <input type="text" class="form-control"  name='nama_bu' >
  </div>
  <div class="form-group">
    <label for="exampleFormControlInput1">Alamat Badan Usaha</label>
    <input type="text" class="form-control" name='alamat_bu' >
  </div>
  <div class="form-group">
...
<br>
 ...
 <a href='/masterbu'><button type="button" class="btn btn-danger" >Kembali</button></a>
</div>
</form>
</div>
</div>
