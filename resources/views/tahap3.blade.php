...
<div class="container">
  <div class="card">
    <div class="card-header bg-primary text-white">Form Registrasi Tahap 3</div>
    <div class="card-body">
<form action='/regisbu/updatetahap3' method='post'>
{{ csrf_field() }}
...
<div class="form-group">
  ...
  @endforeach
  <div class="form-group">
    <label for="exampleFormControlSelect1">Tanggal Surat Teguran I</label>
 ...
 <div>
 <input type="hidden" class="form-control"  name='status_tahap3' id="status_tahap3">
 <br>
 ...
 <script>
  ...
  function kepatuhan()
  {
    ...
    if(patuhnya == "Patuh")
  {
    document.getElementById('status_tahap3').value='Patuh';
  }
