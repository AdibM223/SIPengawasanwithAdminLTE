...
<div class="container">
  <div class="card">
    <div class="card-header bg-primary text-white">Form Registrasi Tahap 5</div>
    <div class="card-body">
<form action='/regisbu/updatetahap5' method='post'>
{{ csrf_field() }}
...
<div class="form-group">
  ...
  @endforeach
  <div class="form-group">
    <label for="exampleFormControlSelect1">Tanggal Sanksi Administratif</label>
    <input type="date" class="form-control" name='tgl_sanksi_administratif' required>
  </div>
  <div class="form-group">
 ...
 <div>
 <input type="hidden" class="form-control"  name='status_tahap5' id="status_tahap5">
 <br>
 ...
 <script>
  ...
  function kepatuhan()
  {
    ...
    if(patuhnya == "Patuh")
  {
    document.getElementById('status_tahap5').value='Patuh';
  }
