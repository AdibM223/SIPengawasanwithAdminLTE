...
<div class="container">
  <div class="card">
    <div class="card-header bg-primary text-white">Form Ubah Data Master - Registrasi Badan Usaha</div>
    <div class="card-body">
<form action='/masterregis/updatemasterregis' method='post'>
{{ csrf_field() }}
@foreach ($masterregis as $p)
  <div class="form-group">
    <label for="exampleFormControlInput1">Kode Registrasi Badan Usaha</label>
    <input type="text" class="form-control"  name='nomorregis' value='{{$p ->nomorregis}}'>
  </div>
  <div class="form-group">
    <label for="exampleFormControlInput1">Nama Badan Usaha</label>
    <input type="text" class="form-control"  name='nama_bu_regis' value='{{$p ->nama_bu_regis}}'>
  </div>
  <div class="form-group">
    <label for="exampleFormControlInput1">Alamat Badan Usaha</label>
    <input type="text" class="form-control" name='alamat_bu_regis' value='{{$p ->alamat_bu_regis}}' >
  </div>
  <div class="form-group">
    <label for="exampleFormControlInput1">Nomor Kontak Badan Usaha</label>
    <input type="text" class="form-control"  name='notelp_bu_regis' value='{{$p ->notelp_bu_regis}}'>
  </div>
  <div class="form-group">
    <label for="exampleFormControlInput1">Penanggung Jawab</label>
    <input type="text" class="form-control" name='PJ_regis' value='{{$p ->PJ_regis}}'>
  </div>

  <div class="form-group">
    <label for="exampleFormControlInput1">Nomor Kontak Penanggung Jawab</label>
    <input type="text" class="form-control"  name='notelp_PJ_regis' value='{{$p ->notelp_PJ_regis}}'>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name='jumlah_karyawan_regis' value='{{$p ->jumlah_karyawan_regis}}'>
  </div>  
